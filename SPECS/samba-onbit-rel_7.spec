...
- Removidos Requires desnecessários (glusterfs-* e grande lista de -devel)
- Runtime Requires agora seguem a documentação oficial do Samba
- Parado de substituir libldb/python3-ldb do sistema (sem Conflicts/Obsoletes para libldb*)
- Restaurados Requires para libldb/python3-ldb da base (evita quebra de sssd-common)
- Mantido replacement apenas para pacotes samba*, libwbclient
- Mantido serviço systemd samba-ad-dc.service e smb.conf básico em /etc/samba
