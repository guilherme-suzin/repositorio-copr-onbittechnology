...
# Macros systemd (já vêm com systemd-rpm-macros no EL9)
...
Requires:       libtalloc
Requires:       libtevent
# para scripts systemd de pós-instalação
Requires(post):   systemd
Requires(preun):  systemd
Requires(postun): systemd

# ====================================================================
# Replacement do stack Samba/libwbclient da distro (NÃO mais libldb)
# ====================================================================
...
# Remover módulos ldb sob /usr/lib64/samba/ldb para evitar conflito de arquivos
# com o pacote libldb da base (que também instala esses .so).
rm -f %{buildroot}%{_libdir}/samba/ldb/*.so || true

# === Unit systemd do Samba AD DC ===
...
# Notifica o systemd sobre a nova unit
